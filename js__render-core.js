...
defineModule('render-core.js', {
  ...
  where: 'js/render-core.js — depends on config.js, clock.js, game-state.js, sprite-loader.js, canvas-layer-manager.js, career-progression.js, physics.js, overlay-ui.js, smart-play.js, abilities.js, save.js',
  who: 'Assistant-A (loop/perf correctness), Assistant-B (real-device feel at 30fps)',
  exports: ['createRenderCore'],
  dependsOn: ['contract.js', 'config.js', 'clock.js', 'game-state.js', 'sprite-loader.js', 'canvas-layer-manager.js', 'career-progression.js', 'physics.js', 'overlay-ui.js', 'smart-play.js', 'abilities.js', 'save.js']
});
...
function createRenderCore(canvasEl) {
  ...
  let physicsWorld = createPhysicsWorld(currentChapterIndex, saveData.gear.equipped, abilityController, null);
  ...
  function startNextPhysicsWorld(advance) {
    ...
    physicsWorld = createPhysicsWorld(currentChapterIndex, saveData.gear.equipped, abilityController, callId);
  ...
  return {
    ...
    overlayUI, smartPlayState, abilityController,
    ...
    /**
     * Loads all manifest assets, THEN starts the loop. Missing assets never
     * block this — loadAll() always resolves, silhouettes cover the gaps.
