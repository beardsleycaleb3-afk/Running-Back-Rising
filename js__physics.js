...
defineModule('physics.js', {
  ...
  where: 'js/physics.js — depends on gear.js, abilities.js, collision-resolution.js, career-progression.js, story.js, rewards.js, spawner.js, smart-play.js',
  who: 'Assistant-A (simulation correctness), Assistant-B (feel at 30fps)',
  exports: ['createPhysicsWorld', 'DRAFT_ELIGIBLE_TEAMS'],
  dependsOn: ['contract.js', 'config.js', 'gear.js', 'abilities.js', 'collision-resolution.js', 'career-progression.js', 'story.js', 'rewards.js', 'spawner.js', 'smart-play.js']
});
 ...
 */
function createPhysicsWorld(chapterIndex, equippedGear, abilityController, smartPlayCallId) {
  ...
  return {
    ...
    update(dt) {
      ...
      const combinedEffects = { ...gearResult.totals, ...abilityEffects };
      for (const key of Object.keys(gearResult.totals)) {
        if (key in abilityEffects) combinedEffects[key] = gearResult.totals[key] + abilityEffects[key];
      }
